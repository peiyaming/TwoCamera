...
import com.umi.twocamera.adapter.ProjectAdapter;
...
import com.umi.twocamera.view.AbOnListViewListener;
import com.umi.twocamera.view.AbPullListView;
...
public class SearchActivity extends AppCompatActivity implements PermissionInterface {
    ...
    private AbPullListView lv_yu;//今日必读列表
